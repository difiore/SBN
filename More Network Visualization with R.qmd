---
title: "More Network Visualization with R"
format:
  html:
...
Many networks are made up of relatively densely connected subgroups (or subgraph) that are connected to one another via fewer edges. A number of methods exist for defining and identify such subgroups.
...
table(coreness) # the largest k-core is 15... every vertex in this core has a degree of at least 15
V(hp)$color <- coreness
visIgraph(hp,
          idToLabel = FALSE,
          layout = "layout_with_kk",
...
# the edge betweenness and infomap algorithms work with directed graphs...
